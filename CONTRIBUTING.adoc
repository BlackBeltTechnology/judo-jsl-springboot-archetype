...
Operational code is usually placed under `src/main/java` while tests are located under the `src/test/java` folder.
...
You can file new issues by filling out our https://github.com/BlackBeltTechnology/judo-jsl-springboot-archetype/issues/new/choose[issue form].
